...
const primaryServices = [
  {
    ...
    tagline:
      "A dewy finish, a radiant, luminous look that gives the appearance of a healthy, glowing complexion.",
  ...
  },
  {
    ...
    tagline:
      "HD makeup is designed to enhance a bride's features & make them stand out in photos and videos.",
  ...
  },
  {
    ...
    tagline:
      "My Signature Bridal Makeup Look gives you a very natural, yet very finished and polished look. This hides blemishes, giving it a smooth and velvety finish.",
  ...
  },
  {
    ...
    tagline:
      "A weightless, seamless veil of micro-fine coverage that lasts from morning rites to the send-off.",
  ...
  return (
    <div className="min-h-screen bg-ivory font-sans text-wine antialiased overflow-x-hidden">
          ...
          <div className="flex flex-col gap-16 sm:gap-24">
            {primaryServices.map((service, idx) => (
              ...
              >
                {/* Photo Side */}
                <div
                  className={`lg:col-span-5 max-w-md mx-auto lg:max-w-none w-full ${idx % 2 === 1 ? "lg:order-2" : ""}`}
                >
                  {service.gallery && service.gallery.length === 3 ? (
                    ...
                    <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-gold/30 shadow-2xl bg-charcoal2 p-2 aspect-[4/5] flex items-center justify-center">
                      <span className="text-gold/50 font-serif text-lg italic">
                        Image Coming Soon
                      </span>
                    </div>
                  )}
                ...
                <div className={`lg:col-span-7 ${idx % 2 === 1 ? "lg:order-1" : ""}`}>
                  <h3 className="mt-1 font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-wine">
                    {service.name}
                  </h3>
                  <p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium text-wine/75 leading-relaxed">
                    {service.tagline}
                  </p>

                  <div className="mt-5 sm:mt-6">
                    <p className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-gold/70 mb-2">
                      Package Includes:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {service.includes.map((i) => (
                        <span
                          key={i}
                          className="rounded-full bg-gold/15 border border-gold/35 px-3 sm:px-4 py-1 sm:py-1.5 text-[11px] sm:text-xs font-bold text-gold"
                        >
                          ✓ {i}
                        </span>
                      ))}
                  ...
                  <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-gold/20 flex flex-wrap items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-[10px] sm:text-xs font-medium text-wine/55">
                        *{service.priceNote}
                      </p>
                    </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mb-10 sm:mb-14 text-center">
            ...
            <p className="mx-auto mt-3 sm:mt-4 max-w-xl text-xs sm:text-sm text-cream/75">
              Explore bespoke styling tailored specifically for each ceremony of your wedding
              festivities.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-charcoal">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="mx-auto mt-4 sm:mt-5 max-w-lg text-cream/75 text-xs sm:text-sm leading-relaxed">
            Limited dates each wedding season. Bookings open months in advance — reach out today for
            availability.
          </p>
          <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-3 sm:gap-4">
            <a
              href="/#contact"
              className="btn-primary text-xs sm:text-sm py-2.5 px-5 sm:py-3 sm:px-7"
            >
              Book an Appointment ✦
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-outline text-xs sm:text-sm py-2.5 px-5 sm:py-3 sm:px-7"
            >
              WhatsApp Us
            </a>
          </div>
          ...
          <div className="grid gap-8 sm:gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            <div>
              ...
              <p className="text-xs leading-relaxed text-cream/60">
                Since 2014. 2000+ happy brides. Available all over India.
              </p>
            </div>
            <div>
              ...
              <ul className="flex flex-col gap-2 text-xs sm:text-sm text-cream/70">
                {[
                  ...
                  <li key={h}>
                    <a href={h} className="hover:text-gold transition font-medium">
                      {l}
                    </a>
                  </li>
                ))}
      ...
      <a
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-gold text-wine shadow-2xl transition hover:scale-110 active:scale-95"
      >
