...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-charcoal font-sans text-cream antialiased overflow-x-hidden">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-gold/15 bg-charcoal/92 backdrop-blur-md shadow-md">
        <div className="mx-auto flex h-16 sm:h-18 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <span className={`block h-0.5 w-6 bg-gold transition-transform duration-300 ${menuOpen ? "translate-y-2 rotate-45" : ""}`} />
              <span className={`block h-0.5 w-6 bg-gold transition-opacity duration-300 ${menuOpen ? "opacity-0" : ""}`} />
              <span className={`block h-0.5 w-6 bg-gold transition-transform duration-300 ${menuOpen ? "-translate-y-2 -rotate-45" : ""}`} />
            </button>
          </div>
        </div>
      ...
      <section id="services" className="py-16 sm:py-24 bg-charcoal text-cream">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mb-10 sm:mb-14 text-center">
            ...
            <p className="mx-auto mt-3 sm:mt-4 max-w-2xl text-xs sm:text-sm text-cream/75 leading-relaxed">
            ...
            {primaryServices.map((service) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5 sm:p-6 min-h-[14rem]">
                  ...
                  <p className="mt-2 text-xs leading-relaxed text-cream/75 flex-1">{service.tagline}</p>
                  ...
                  <div className="mt-auto pt-5 sm:pt-6 border-t border-gold/20 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[10px] font-medium text-cream/60">*{service.priceNote}</p>
                    </div>
      ...
      <section className="py-16 sm:py-24 bg-charcoal2 text-cream">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
           <div className="mb-10 sm:mb-14 text-center">
